...
namespace TUVienna.CS_CUP.Runtime
{
     ...
     * To:
     * version last updated:08.09.2003
     * author Samuel Imriska
     */

    /*Simple wrapper class for Stack to emulate java function elementAt
     * which is missing in C#
     * JCM : 02/05/2018 No Need to use a subclass of Stack. Just extract the
     * underlying array to perform direct access in it.
  ...
  public virtual void report_error(string message, object info)
	...
	System.Console.Error.WriteLine(" at character " + ((Symbol)info).left + 
			   " of input");
	else System.Console.Error.WriteLine("");
      else System.Console.Error.WriteLine("");
    }
  ...
  public void debug_message(string mess)
    {
      System.Console.Error.WriteLine(mess);
    }
  ...
  /*-----------------------------------------------------------*/
    ...
    protected static int GetChar(string s,ref int n)
    {
        ...
        if (s[n+1]=='u')
        {
            res= System.Int32.Parse(s.Substring(n+2,4),System.Globalization.NumberStyles.AllowHexSpecifier);
            n+=6;
        }
        else
        {
            res=System.Int32.Parse(s.Substring(n+1,1))*64+System.Int32.Parse(s.Substring(n+2,1))*8+System.Int32.Parse(s.Substring(n+3,1));
            n+=4;
        }
        return res;
    }
   ...
   * in C# version is the delimiter between encodings / instead of \ 
   */
