...
namespace TypeCobol.Codegen.Nodes {
    ...
    /// </summary>
	public new ProcedureStyleCallStatement CodeElement { get { return this.Node.CodeElement; } }

    protected override CodeElement InternalCodeElement => this.Node.CodeElement;
