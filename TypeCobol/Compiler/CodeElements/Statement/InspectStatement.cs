namespace TypeCobol.Compiler.CodeElements {
    ...
    public abstract class InspectStatement : StatementElement {
        ...
        public override bool VisitCodeElement(IASTVisitor astVisitor) {
            return base.VisitCodeElement(astVisitor)
                /*&& astVisitor.Visit(this) InspectStatement is abstract and seems not useful for the visitor*/
                   && this.ContinueVisitToChildren(astVisitor, InspectedItem);
        }
        ...
        /// </summary>
        public class CountingOrReplacingCondition : IVisitable {
            /// <summary>
            ...
            public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                return this.ContinueVisitToChildren(astVisitor, StartCharacterPosition, InitialOccurence, Delimiter);
            }
        }
    ...
    public class InspectTallyingStatement : InspectStatement {
        ...
        public override bool VisitCodeElement(IASTVisitor astVisitor) {
            return base.VisitCodeElement(astVisitor) && astVisitor.Visit(this)
                   && this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) TallyingInstructions);
        }
        ...
        /// data item.
        /// </summary>
        public class InspectTallyingInstruction : IVisitable {
            /// <summary>
            /// p350:
            /// identifier-2
            ...
            public class CountAllCharactersOperation : IVisitable {
                public CountingOrReplacingCondition[] CountingConditions { get; set; }

                public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                    return this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) CountingConditions);
                }
            }

            public class CountCharacterStringsOperation : IVisitable {
                ...
                public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                    return
                        this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) CharacterStringPatterns) &&
                        this.ContinueVisitToChildren(astVisitor, CharacterStringsSelection);
                }
            }

            public class CountCharacterStringPattern : IVisitable {
                public AlphanumericVariable SearchedCharacterString { get; set; }
                public CountingOrReplacingCondition[] CountingConditions { get; set; }

                public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                    return this.ContinueVisitToChildren(astVisitor, SearchedCharacterString) &&
                           this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) CountingConditions);
                }
            }

            public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                return this.ContinueVisitToChildren(astVisitor, CountField) &&
                       this.ContinueVisitToChildren(astVisitor, CountAllCharactersOperations,
                           CountCharacterStringsOperations);
            }
        }
    ...
    public class InspectReplacingStatement : InspectTallyingStatement {
        ...
        {
            return base.VisitCodeElement(astVisitor) && astVisitor.Visit(this)
                   && this.ContinueVisitToChildren(astVisitor, ReplaceAllCharactersOperations, ReplaceCharacterStringsOperations);
        }

        public class ReplaceAllCharactersOperation : IVisitable {
            ...
            public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                return this.ContinueVisitToChildren(astVisitor, ReplacingCharacterString) &&
                       this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) ReplacingConditions);
            }
        }

        public class ReplaceCharacterStringsOperation : IVisitable {
            public SyntaxProperty<CharacterStringsSelection> CharacterStringsSelection { get; set; }
            public ReplaceCharacterStringPattern[] CharacterStringPatterns { get; set; }

            public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                return this.ContinueVisitToChildren(astVisitor, CharacterStringsSelection) &&
                       this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) CharacterStringPatterns);
            }
        }

        public class ReplaceCharacterStringPattern : IVisitable {
            public AlphanumericVariable SearchedCharacterString { get; set; }
            public AlphanumericVariable ReplacingCharacterString { get; set; }
            public CountingOrReplacingCondition[] ReplacingConditions { get; set; }

            public bool AcceptASTVisitor(IASTVisitor astVisitor) {
                return this.ContinueVisitToChildren(astVisitor, SearchedCharacterString, ReplacingCharacterString) &&
                       this.ContinueVisitToChildren(astVisitor, (IEnumerable<IVisitable>) ReplacingConditions);
            }
        }
    }
