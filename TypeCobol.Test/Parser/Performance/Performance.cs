...
namespace TypeCobol.Test.Parser.Performance
{
    ...
    public class Performance
    {
        ...
        {
            IncrementalPerformance2(PlatformUtils.GetPathForProjectFile("ThirdParty" + Path.DirectorySeparatorChar + "CNAF" + Path.DirectorySeparatorChar + "Batch"), "CGMX02.COB", 
                160321, "           MOVE LKMO-ZDSVCM        TO ACFH-ZDSVCM.                      CGRXH7P");
        }
        ...
        public void FullParsingAndGenerationTest()
        {
            ...
            FullParsingAndGenerationTest2(Directory.GetParent(pwd)?.Parent?.FullName + "\\TypeCobol.Test\\ThirdParty\\CNAF\\Batch\\CGMX02.COB");
        }
